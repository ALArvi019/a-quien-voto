        ...
        {loading ? (
          ...
          <div className="text-center py-12 space-y-4">
            ...
            <button
              ...
              className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition-colors cursor-pointer"
            >
              Hacer el test
            </button>
          </div>
                ...
                {parties.map((party) => {
                  ...
                  return (
                    <div key={party.id} className="flex items-center gap-3">
                      <img src={party.logo} alt={party.shortName} className="w-8 h-8 rounded-lg" />
                      ...
                      {provStats
                        ...
                        .map((ps) => (
                          ...
                          >
                            ...
                            <td className="py-2 px-1 text-center text-gray-500">{ps.total}</td>
                            {parties.map((p) => (
